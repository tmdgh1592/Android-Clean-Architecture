...
import com.architecture.clean.movie.R
import com.architecture.clean.presentation.utils.NetworkConnection
import com.google.android.material.snackbar.Snackbar
import io.reactivex.rxjava3.disposables.CompositeDisposable


abstract class BaseActivity<T : ViewDataBinding, S : BaseViewModel>(@LayoutRes val layoutResId: Int) :
    AppCompatActivity() {
    ...
    private fun createInternetCheckDialog() {
        val snackbar = Snackbar.make(
            ...
            getString(R.string.snack_bar_content_internet_disconnected),
